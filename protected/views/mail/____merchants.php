...
<!-- HEADER -->
  ...
  <tr>
		<td style="min-width: 590px;" align="center">
                ...
                <div>
									<p style="margin-top: 28px;font-size: 14px;">il tuo account Commerciante è stato creato!</p>
								</div>
								<div>
									<p style="margin-top: 28px;font-size: 14px;">Clicca sul pulsante seguente per collegarti.</p>
								</div>
								<div>
												<a href="<?php echo $URL;?>">
