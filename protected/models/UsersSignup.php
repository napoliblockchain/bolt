 ...
 */
class UsersSignup extends CActiveRecord
{
	...
	public function rules()
	{
		...
		if (gethostname()=='CGF6135T'){
			return array(
				...
				array('email', 'email',  'message'=>Yii::t('lang','The inserted email is not valid.'),'on'=>'insert'),

				array('status_activation_code', 'numerical', 'integerOnly'=>true),
				array('email, password ', 'length', 'max'=>255),

				array('reCaptcha ', 'required','on'=>'insert'),
