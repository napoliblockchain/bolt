...
class Notifications_readers extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_user, id_notification', 'numerical', 'integerOnly'=>true),

			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_notifications_reader, id_notification, id_user', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'id_notifications_reader' => Yii::t('model','id_notifications_reader'),
	...
	public function search()
	{
		...
		$criteria->compare('id_notifications_reader',$this->id_notifications_reader);
